...
class Detector private constructor(
    ...
    class Builder(private val context: Context, private val modelPath: String, private val labelPath: String) {
        private var coroutineScope: CoroutineScope? = null

        fun setCoroutineScope(coroutineScope: CoroutineScope?) = apply { this.coroutineScope = coroutineScope }

        fun build() = Detector(context, modelPath, labelPath, coroutineScope)
    }
}